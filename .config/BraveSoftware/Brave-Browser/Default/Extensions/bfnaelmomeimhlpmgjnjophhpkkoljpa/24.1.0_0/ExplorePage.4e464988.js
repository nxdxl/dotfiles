...
function e(e){return e&&e.__esModule?e.default:e}function t(e,t,n,r){Object.defineProperty(e,t,{get:n,set:r,enumerable:!0,configurable:!0})}var n=("undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{}).parcelRequire1d24;n.register("Cx7PX",(function(r,l){var i;i=r.exports,Object.defineProperty(i,"__esModule",{value:!0,configurable:!0}),t(r.exports,"ExplorePageContent",(function(){return S})),t(r.exports,"default",(function(){return P}));var a=n("54qyi"),o=n("lBuGR"),s=n("egSKH"),c=n("lDSNw"),d=n("bjaYq"),u=n("lz7nT"),p=n("5Z2YQ"),m=n("cZIbv"),x=n("cecAp"),f=n("kn91D"),g=n("fnNJD"),h=n("cHds5"),E=n("dk3Xb"),b=n("1tudC"),w=n("gMNJN"),k=n("hAsXk"),y=n("iacGS"),v=n("d1qx3");function S(){var t;w.hooks.useExploreLoadAllQueries();const n=(0,u.useLocation)(),{t:r}=(0,d.useTranslation)(),l=(0,k.useShouldShowQuests)(),{error:i,refetch:o}=w.hooks.useQuests({platform:"extension",appVersion:(0,v.getManifestVersion)()}),{setActiveTab:m,activeTab:x}=(0,a.useExplore)();(0,c.useEffect)((()=>{var e;"quests"===(null===(e=n.state)||void 0===e?void 0:e.tab)&&l&&!i&&m(3)}),[null===(t=n.state)||void 0===t?void 0:t.tab,l,i,m]);const{error:f,refetch:S}=w.hooks.useLearn(),{error:N,refetch:P}=w.hooks.useExploreTokens(),{error:T,refetch:A}=w.hooks.useExploreSites(),{error:R,refetch:$}=w.hooks.useExploreCollections(),{error:M,refetch:j}=w.hooks.useExploreRecommendedTokens(),{error:z,refetch:F}=w.hooks.useExploreRecommendedSites(),{error:Z,refetch:_}=w.hooks.useExploreRecommendedCollections(),B=i&&f&&N&&T&&R&&M&&z&&Z,G=(0,c.useCallback)((()=>{l&&o(),P(),A(),$(),j(),F(),_(),S()}),[o,P,A,$,j,F,_,S,l]),[O,Q]=e(c).useState(""),q=(0,p.useDebouncedState)(O,250),U=e(s)((e=>{e&&y.exploreAnalytics.onExploreSearchedByUser({searchTerm:e})}),1e3);return(0,c.useEffect)((()=>{U(q)}),[q,U]),B?e(c).createElement(C,null,e(c).createElement(g.ExplorePageError,{title:r("exploreErrorTitle"),buttonText:r("exploreErrorButtonText"),description:r("exploreErrorDescription"),refetch:G})):e(c).createElement("div",null,e(c).createElement(h.ExploreSearchHeader,{value:O,onChange:Q}),e(c).createElement(I,{hide:!!q},e(c).createElement(b.ExploreTabs,null),1===x&&e(c).createElement(L,null,e(c).createElement(D,null,r("exploreTokensLegalDisclaimer")))),e(c).createElement(I,{hide:!q},e(c).createElement(E.ExploreSearchResults,{query:q})))}const C=m.default.div`
  padding: 16px;
`,I=m.default.div`
...
`,x=({src:t,fallback:n,alt:r,size:l="normal",shape:a="circle",style:o})=>{const c=null!=n?n:e(i).createElement(f,null,"?"),x=u(l),g=u(l),h=(e=>"square"===e?6:0)(a);return"circle"===a?e(i).createElement(s.Circle,{color:"#222222",diameter:x,style:o},e(i).createElement(p,{src:t,fallback:c,alt:r||void 0,width:x,height:g,borderradius:h,loader:e(i).createElement(d.SkeletonLoader,{borderRadius:`${h}px`,width:`${x}px`,height:`${g}px`})})):e(i).createElement(m,{color:"#222222",width:x,height:g,style:o},e(i).createElement(p,{src:t,fallback:c,alt:r||"",width:x,height:g,borderradius:h,loader:e(i).createElement(d.SkeletonLoader,{borderRadius:`${h}px`,width:`${x}px`,height:`${g}px`})}))},f=o.default.div`
  ...
  align-items: center;
  justify-content: center;
`})),n.register("iacGS",(function(e,r){t(e.exports,"exploreAnalytics",(function(){return a}));var l=n("54qyi"),i=n("h5kyv");const a=new(0,l.ExploreAnalytics)(i.analytics)})),n.register("3A33D",(function(e,r){t(e.exports,"useExploreSearchList",(function(){return c}));var l=n("54qyi"),i=n("4y59b"),a=n("gmVmN"),o=n("gMNJN"),s=n("GbSLs");const c=e=>{const t=o.hooks.useEnabledNetworkIDs(),{data:n,isLoading:r}=o.hooks.useRecommendedSearchSites({networkIds:t});return{dapps:(0,s.useFuse)(n||[],(0,a.removeWebPrefixes)(e),l.FUSE_EXPLORE_DAPPS_CONFIG).map((e=>Object.assign(Object.assign({},e),{href:(0,i.getOriginAndHostname)(e.domain).origin}))),isLoading:r}}})),n.register("1tudC",(function(r,l){t(r.exports,"ExploreTabs",(function(){return L}));var i=n("54qyi"),a=n("lMzyG"),o=n("lDSNw"),s=n("cecAp"),c=n("gMNJN"),d=n("hAsXk"),u=n("iacGS"),p=n("d1qx3"),m=n("gBwyG"),x=n("fs8H6"),f=n("iBj6N"),g=n("9yEL6"),h=n("hTknS"),E=n("5oT4X"),b=n("4jLAN"),w=n("706Mc"),k=n("dA6Zr"),y=n("gt4Z2"),v=n("YBIrC");const S=()=>{const{isLoading:t,isPreviousData:n}=c.hooks.useExploreSites(),{isLoading:r}=c.hooks.useExploreSortOption();return e(o).createElement("div",null,e(o).createElement(f.CarouselSites,null),!t&&!r||n?e(o).createElement(h.default,{tab:"sites"}):e(o).createElement(E.ExploreFiltersSkeleton,null),e(o).createElement(k.ExploreListSites,null))},C=()=>{const{isLoading:t,isPreviousData:n}=c.hooks.useExploreTokens(),{isLoading:r,currentSortOption:l}=c.hooks.useExploreSortOption(),i=l("tokens");return e(o).createElement("div",null,e(o).createElement(g.CarouselTokens,null),!t&&!r||n?e(o).createElement(h.default,{tab:"tokens"}):e(o).createElement(E.ExploreFiltersSkeleton,null),e(o).createElement(y.ExploreListTokens,{displayType:i}))},I=()=>{const{isLoading:t,isPreviousData:n}=c.hooks.useExploreCollections(),{isLoading:r}=c.hooks.useExploreSortOption();return e(o).createElement("div",null,e(o).createElement(x.CarouselCollections,null),!t&&!r||n?e(o).createElement(h.default,{tab:"collections"}):e(o).createElement(E.ExploreFiltersSkeleton,null),e(o).createElement(w.ExploreListCollections,null))};function L(){const{activeTab:t,setActiveTab:n}=(0,i.useExplore)(),{t:r}=(0,a.useTranslation)(),l=(0,d.useShouldShowQuests)(),{error:x}=c.hooks.useQuests({platform:"extension",appVersion:(0,p.getManifestVersion)()}),f=(0,o.useMemo)((()=>{const t=l&&!x;return[{title:r("exploreApps"),name:"sites",element:e(o).createElement(S,null)},{title:r("exploreTokens"),name:"tokens",element:e(o).createElement(C,null)},{title:r("exploreCollections"),name:"collections",element:e(o).createElement(I,null)},...t?[{title:r("quests"),name:"quests",element:e(o).createElement(s.Quests,{titleVisible:!1})}]:[],{title:r("exploreLearn"),name:"learn",element:e(o).createElement(b.Learn,null)}].filter(Boolean)}),[l,x,r]),g=(0,o.useMemo)((()=>f.map((e=>e.title))),[f]),h=(0,o.useMemo)((()=>f.map((e=>e.element))),[f]);return 0===f.length?null:e(o).createElement("div",null,e(o).createElement(v.default,{values:g,activeTabIndex:t,setActiveTabIndex:e=>{n(e),u.exploreAnalytics.onExploreTabClickedByUser({tabName:f[e].name})}}),e(o).createElement(m.default,{activeIndex:t,items:h}))}})),n.register("gBwyG",(function(r,l){t(r.exports,"default",(function(){return s}));var i=n("lDSNw"),a=n("jVSWn"),o=n("cZIbv");function s({activeIndex:t,items:n,animateFirstTime:r=!1}){const[l,o]=e(i).useState(!0),s=(0,a.default)(t),u=t-(s||0)>0;return(0,i.useEffect)((()=>{t!==s&&o(!1)}),[t,s,o]),e(i).createElement(d,null,n.map(((n,a)=>e(i).createElement(c,{key:`animation-slide-left-${a}`,testID:`animation-item-${a}`,active:t===a,isLeft:u,shouldAnimate:!!r||!l,inView:!u&&t===a-1||u&&t===a+1||t===a},n))))}const c=({active:t,children:n,testID:r,isLeft:l,shouldAnimate:a,inView:o})=>e(i).createElement(u,{active:t,"data-testid":r,shouldAnimate:a,isLeft:l,inView:o},n),d=o.default.div`
  position: relative;
  width: 100%;
...
`,S=s.default.div`
  ...
  align-items: center;
  justify-content: center;
`})),n.register("YBIrC",(function(r,l){t(r.exports,"default",(function(){return m}));var i=n("bK93X"),a=n("c1thM"),o=n("1bdlq"),s=n("lDSNw"),c=n("cZIbv"),d=n("iacGS");const u=e=>e.reduce(((e,t)=>e+16*t.length+16),0),p={duration:.3,delay:0,ease:"easeOut"};function m({values:t,activeTabIndex:n,setActiveTabIndex:r}){const[l,a]=(0,s.useState)(!1),c=(0,o.useMotionValue)(n>2?-1*u(t.slice(3,n+1)):0),m=(0,s.useMemo)((()=>{const e=window.innerWidth-u(t);return e<0?e:0}),[t]);return e(s).createElement(x,null,e(s).createElement(f,{drag:"x",style:{x:c},dragConstraints:{left:m,right:0},onDragStart:()=>a(!0),onDragEnd:()=>{a(!1),d.exploreAnalytics.onExploreTabTitlesDragged()}},t.map(((a,o)=>e(s).createElement(g,{"data-testid":`tab-title-${a}`,key:`tab-title-${o}`,active:n===o},e(s).createElement(h,{onClick:e=>{if(l)return e.stopPropagation(),void e.preventDefault();r(o),(e=>{const n=u(t.slice(0,e));if(n<window.innerWidth)return void(0,i.animate)(c,0,p);const r=window.innerWidth-n;(0,i.animate)(c,r,p)})(o)},isActive:n===o},a))))))}const x=c.default.div`
